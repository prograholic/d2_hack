...
//        baseColour = vec4(material.colour, 1);
  ...
  //  else
    {
        baseColour = texture(MainTexture, ComputedTexCoord);
    }
    //vec4 totalLight = vec4(ambientLight, 1.0);
    //totalLight += calcDirectionalLight(directionalLight, ComputedVertexPos, ComputedVertexNormal);
    //totalLight += calcPointLight(pointLight, ComputedVertexPos, ComputedVertexNormal); 
