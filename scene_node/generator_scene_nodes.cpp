...
TerrainSceneNode2::TerrainSceneNode2(const std::string_view& name, Ogre::SceneManager* sceneManager)
...
Ogre::Vector3f TerrainSceneNode2::GetAbsolutePosition() const
{
    OGRE_EXCEPT(Ogre::Exception::ERR_NOT_IMPLEMENTED, "TerrainSceneNode2::GetAbsolutePosition is not implemented");
}

Ogre::Quaternion TerrainSceneNode2::GetAbsoluteOrientation() const
{
    OGRE_EXCEPT(Ogre::Exception::ERR_NOT_IMPLEMENTED, "TerrainSceneNode2::GetAbsoluteOrientation is not implemented");
}

void TerrainSceneNode2::CreateTerrain()
{
    ConfigureTerrainDefaults();
...
void TerrainSceneNode2::ConfigureTerrainDefaults()
{
    m_terrainGlobalOptions->setMaxPixelError(8);
    // testing composite map
    m_terrainGlobalOptions->setCompositeMapDistance(3000);
...
void TerrainSceneNode2::DefineTerrains()
{
    // TODO: reorganize image rotating
    Ogre::Image img0;
    img0.load(HeightMap0Name, common::DefaultResourceGroup);
...
TreeGeneratorSceneNode2::TreeGeneratorSceneNode2(
    const std::string_view& name,
    const block_data::SimpleGeneratedObjects40& data,
    const std::string_view& b3dId,
    Ogre::SceneManager* sceneManager,
    ...
    : SceneNode<block_data::SimpleGeneratedObjectsBlock40, SceneNodeBase>(name)
{
    ...
    if (!treeMesh)
    {
        D2_HACK_LOG(TreeGeneratorSceneNode2::TreeGeneratorSceneNode2) << "cannot find mesh \"" << treeParams.meshName << "\", create new...";
        treeMesh = CreateMesh(treeParams, sceneManager);
    }
    else
    {
        D2_HACK_LOG(TreeGeneratorSceneNode2::TreeGeneratorSceneNode2) << "reuse mesh \"" << treeParams.meshName << "\"";
    }
    ...
    {
        D2_HACK_LOG(TreeGeneratorSceneNode2::TreeGeneratorSceneNode2) << "Cannot find material \"" << treeParams.materialName << "\"";
    }
...
Ogre::Vector3f TreeGeneratorSceneNode2::GetAbsolutePosition() const
{
    OGRE_EXCEPT(Ogre::Exception::ERR_NOT_IMPLEMENTED, "TreeGeneratorSceneNode2::GetAbsolutePosition is not implemented");
}

Ogre::Quaternion TreeGeneratorSceneNode2::GetAbsoluteOrientation() const
{
    OGRE_EXCEPT(Ogre::Exception::ERR_NOT_IMPLEMENTED, "TreeGeneratorSceneNode2::GetAbsoluteOrientation is not implemented");
}

Ogre::MeshPtr TreeGeneratorSceneNode2::CreateMesh(const TreeGeneratorSceneNode2::TreeParams& treeParams, Ogre::SceneManager* sceneManager)
{
    Ogre::ManualObject* obj = sceneManager->createManualObject();
...
TreeGeneratorSceneNode2::TreeParams TreeGeneratorSceneNode2::DeduceTreeParams(const block_data::SimpleGeneratedObjects40& data, const std::string_view& b3dId)
{
    TreeParams res;
